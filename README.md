# Clip Announcer Accessibility Tool 1.2
...
- `community-reference/`: shareable Session View developer reference pack for the Max for Live community.
...
- Community-facing reference materials are collected in [`community-reference/README.md`](community-reference/README.md).
